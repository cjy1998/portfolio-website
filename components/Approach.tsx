      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center  gap-4">
        ...
        <Card
          ...
          description="Once we agree on the plan,
                        ...
                        From initial sketches to polished code, 
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20">
        ...
        transition duration-200 w-full  m
        x-auto flex items-center justify-center"
        >
          {icon}
        </div>
        <h2
  ...
  return (
    <div>
      ...
      >
        <span
          className="absolute 
        inset-[-1000%] animate-[spin_2s_linear_infinite] 
        ...
        text-xl font-bold text-white backdrop-blur-3xl"
        >
          {order}
        </span>
      </button>
